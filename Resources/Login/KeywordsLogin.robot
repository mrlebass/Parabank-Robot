...
Dado que o usuário esteja na tela de Login
    Esperar elemento visivel       ${CAMPO_USUARIO}          10s
    Element Should Be Visible        ${CAMPO_USUARIO}          
    Esperar elemento visivel       ${CAMPO_SENHA}            10s
...
Então ele deve ser redirecionado para a página inicial
    Esperar elemento visivel       ${BTN_LOGOUT}             10s
...
Então ele NÃO deve ser redirecionado para a página inicial
    ...
    Esperar elemento visivel       ${MSG_ERROR_LOGIN}         10s
